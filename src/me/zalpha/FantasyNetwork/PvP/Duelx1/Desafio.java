...
public class Desafio
{
    ...
    public Desafio(final Player desafiante, final Player desafiado, final String espada, final String armadura, final String refil, final boolean speed, final boolean strenght, final boolean sharp, final int level) {
        this.level = 1;
        this.desafiante = desafiante;
        this.desafiado = desafiado;
        this.espada = espada;
