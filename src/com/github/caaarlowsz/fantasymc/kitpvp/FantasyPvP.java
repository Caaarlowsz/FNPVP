...
public class FantasyPvP extends JavaPlugin implements KitPvP, Listener {
    ...
    private static FantasyPvP main;
    public static FantasyPvP instance;
    public Sql storage;
    public int time;
    ...
    public static FantasyPvP getInstace() {
        return FantasyPvP.instance;
    }
    ...
    public void enable() {
        FantasyPvP.plugin = this;
        (FantasyPvP.main = this).InicarConexaoBungee();
        ...
        Bukkit.getScheduler().runTaskTimer(this, new Runnable() {
            ...
            public void run() {
                ...
                for (final Map.Entry<Player, Long> ks : FantasyPvP.this.times.entrySet()) {
                    if (!ks.getKey().isOnline()) {
                        ...
                        FantasyPvP.this.getServer().dispatchCommand(
                                FantasyPvP.this.getServer().getConsoleSender(),
                                "kick " + ks.getKey().getName() + " Kickado por esta AFK");
                    }
                }
                for (final Player p2 : p) {
                    FantasyPvP.this.times.remove(p2);
                }
            }
        }, 0L, 20L);
    ...
    public static Plugin getPlugin() {
        return FantasyPvP.plugin;
    }

    public static FantasyPvP getMain() {
        return FantasyPvP.main;
    }
