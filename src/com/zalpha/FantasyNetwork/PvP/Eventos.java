...
public class Eventos implements Listener
{
    ...
    public void staffchat(final AsyncPlayerChatEvent e) {
        ...
        for (final Player online : Bukkit.getOnlinePlayers()) {
            if (Manager.comStaffAtivado(p)) {
                ...
                online.sendMessage("§7\u276a §c§lSTAFFCHAT §7| " + p.getDisplayName() + " §7\u276b " + e.getMessage().replace("&", "§"));
            }
        }
    }
    ...
    public void onTeleport(final PlayerTeleportEvent event) {
        if (event.getCause().equals((Object)PlayerTeleportEvent.TeleportCause.ENDER_PEARL) && !Manager.comKit(event.getPlayer())) {
    ...
    private void entrar(final PlayerJoinEvent e) {
        ...
        for (final String msg : ConfigAPI.pegarConfig().pegarconfigMensagens().getStringList("Mensagem_Entrar")) {
            p.sendMessage(msg.replace("<online>", new StringBuilder(String.valueOf(Bukkit.getOnlinePlayers().size())).toString()).replace("<jogador>", p.getName()).replace("&", "§"));
        }
        Manager.darItens(p);
        ...
        if (!Manager.comTellAtivado(p)) {
            p.sendMessage(String.valueOf(Manager.prefix) + " §cAten\u00e7ao!, Voce N\u00e3o Esta Recebendo Mensagens De Tell, Caso Queira Ativar Use /toggle.");
        }
        if (!Manager.comReportAtivado(p) && p.hasPermission("fantasy.veravisos")) {
            p.sendMessage(String.valueOf(Manager.prefix) + " §cAten\u00e7ao!, Voce N\u00e3o Esta Recebendo Reports, Caso Queira Ativar Use /toggle.");
        }
    ...
    public void onPreProcessCommand(final PlayerCommandPreprocessEvent event) {
        if (event.getMessage().toLowerCase().startsWith("/me ")) {
            event.getPlayer().sendMessage(String.valueOf(Manager.prefix) + " §cDesculpe, Mas Este Comando N\u00e3o Foi Encontrado No Banco De Dados Do Servidor.");
            event.setCancelled(true);
        }
        ...
        if (event.getMessage().toLowerCase().startsWith("/plugins") && !event.getMessage().toLowerCase().startsWith("/pl") && !event.getMessage().toLowerCase().startsWith("/plot")) {
            event.getPlayer().sendMessage("");
            event.getPlayer().sendMessage("§e§l\u279c §7Plugin FantasyNetwork §f- §aKitPvP");
            event.getPlayer().sendMessage("§e§l\u279c §7Site §f" + ConfigAPI.pegarConfig().pegarconfigMensagens().getString("Site"));
            event.getPlayer().sendMessage("");
            event.setCancelled(true);
        }
        if (event.getMessage().toLowerCase().startsWith("/pl") && !event.getMessage().toLowerCase().startsWith("/plot")) {
            event.getPlayer().sendMessage("");
            event.getPlayer().sendMessage("§e§l\u279c §7Plugin FantasyNetwork §f- §aKitPvP");
            event.getPlayer().sendMessage("§e§l\u279c §7Site §f" + ConfigAPI.pegarConfig().pegarconfigMensagens().getString("Site"));
            event.getPlayer().sendMessage("");
    ...
    private void naoquebraritens(final EntityDamageByEntityEvent e) {
        if (e.getDamager() instanceof Player) {
            ...
            if (p2.getItemInHand().getType().name().contains("SWORD") || p2.getItemInHand().getType().name().contains("AXE") || p2.getItemInHand().getType().name().contains("PICKAXE") || p2.getItemInHand().getType().name().contains("AXE")) {
    ...
    private void sopa(final PlayerInteractEvent e) {
        ...
        if (p.getItemInHand().getType() == Material.MUSHROOM_SOUP && e.getAction().name().contains("RIGHT") && craftp.getHealth() < craftp.getMaxHealth()) {
    ...
    private void comandoerrado(final PlayerCommandPreprocessEvent e) {
        ...
        if (!e.isCancelled()) {
            ...
            if (help == null) {
                e.setCancelled(true);
                e.getPlayer().sendMessage(String.valueOf(Manager.prefix) + " §cDesculpe, mas este comando n\u00e3o foi encontrado no banco de dados do servidor.");
            }
        }
    }
    ...
    private void naodrop(final PlayerDropItemEvent e) {
        if (e.getItemDrop().getItemStack().getType() == Material.EMERALD | e.getItemDrop().getItemStack().getType() == Material.CHEST | e.getItemDrop().getItemStack().getType() == Material.COMPASS | e.getItemDrop().getItemStack().getType() == Material.INK_SACK | e.getItemDrop().getItemStack().getType() == Material.BLAZE_POWDER | e.getItemDrop().getItemStack().getType() == Material.COOKIE | e.getItemDrop().getItemStack().getType() == Material.DIAMOND | e.getItemDrop().getItemStack().getType() == Material.FIREWORK | e.getItemDrop().getItemStack().getType() == Material.GOLD_BARDING | e.getItemDrop().getItemStack().getType() == Material.FIRE | e.getItemDrop().getItemStack().getType() == Material.DIAMOND_BARDING | e.getItemDrop().getItemStack().getType() == Material.FIREWORK_CHARGE | e.getItemDrop().getItemStack().getType() == Material.FLINT | e.getItemDrop().getItemStack().getType() == Material.STICK | e.getItemDrop().getItemStack().getType() == Material.TNT | e.getItemDrop().getItemStack().getType() == Material.MELON_BLOCK | e.getItemDrop().getItemStack().getType() == Material.MONSTER_EGG | e.getItemDrop().getItemStack().getType() == Material.GOLD_INGOT | e.getItemDrop().getItemStack().getType() == Material.WOOL | e.getItemDrop().getItemStack().getType() == Material.BED | e.getItemDrop().getItemStack().getType() == Material.ENCHANTED_BOOK | e.getItemDrop().getItemStack().getType() == Material.NETHER_STAR | e.getItemDrop().getItemStack().getType() == Material.SKULL_ITEM | e.getItemDrop().getItemStack().getType() == Material.BLAZE_ROD | e.getItemDrop().getItemStack().getType() == Material.ANVIL | e.getItemDrop().getItemStack().getType() == Material.WOOD_SWORD | e.getItemDrop().getItemStack().getType() == Material.IRON_SWORD | e.getItemDrop().getItemStack().getType() == Material.STONE_SWORD | e.getItemDrop().getItemStack().getType() == Material.IRON_SWORD | e.getItemDrop().getItemStack().getType() == Material.DIAMOND_SWORD) {
            e.setCancelled(true);
        }
        else {
            e.setCancelled(false);
    ...
    private void naodroparitens(final PlayerDropItemEvent e) {
        if (e.getItemDrop().getItemStack().getType() == Material.STORAGE_MINECART | e.getItemDrop().getItemStack().getType() == Material.PAPER | e.getItemDrop().getItemStack().getType() == Material.GOLD_INGOT | e.getItemDrop().getItemStack().getType() == Material.IRON_CHESTPLATE | e.getItemDrop().getItemStack().getType() == Material.EMERALD | e.getItemDrop().getItemStack().getType() == Material.EXPLOSIVE_MINECART) {
            e.setCancelled(true);
        }
    ...
    private void morrer(final PlayerDeathEvent e) {
        ...
        if (vitima.getKiller() != null) {
            if (vitima.getKiller() instanceof Player && e.getEntity() instanceof Player) {
                ...
                Bukkit.getPluginManager().callEvent((Event)new PlayerDeathInWarpEvent(vitima, matador, Manager.pegarKit(vitima)));
                for (final Player pl : Duelx1.playersIn1v1) {
            ...
            Manager.removerArrays(vitima);
            Bukkit.getPluginManager().callEvent((Event)new PlayerDeathInWarpEvent(vitima, null, Manager.pegarKit(vitima)));
            e.setDeathMessage((String)null);
            e.getDrops().clear();
        }
    }
    ...
    private void kits(final PlayerInteractEvent e) {
        final Player p = e.getPlayer();
        if (p.getItemInHand().getType() == Material.CHEST && e.getAction().name().contains("RIGHT_") && !Manager.comKit(p)) {
            p.updateInventory();
            e.setCancelled(true);
            new InventarioKits(p, MenuPaged.Type.KITS);
        }
        if (p.getItemInHand().getType() == Material.BOOK && e.getAction().name().contains("RIGHT_") && !Manager.comKit(p)) {
            p.updateInventory();
            e.setCancelled(true);
            new InventarioKits(p, MenuPaged.Type.WARPS);
        }
        if (p.getItemInHand().getType() == Material.EMERALD && e.getAction().name().contains("RIGHT_") && !Manager.comKit(p)) {
            p.updateInventory();
            e.setCancelled(true);
            p.sendMessage(String.valueOf(Manager.prefix) + " §7Site: §a" + ConfigAPI.pegarConfig().pegarconfigMensagens().getString("Site"));
        }
        if (p.getItemInHand().getType() == Material.SKULL_ITEM && e.getAction().name().contains("RIGHT_") && !Manager.comKit(p)) {
            p.updateInventory();
            e.setCancelled(true);
    ...
    private void naomoverteleport(final PlayerMoveEvent e) {
        final Player p = e.getPlayer();
        if (Manager.teleportnaomover.contains(p) && (e.getFrom().getX() != e.getTo().getX() || e.getFrom().getZ() != e.getTo().getZ() || e.getFrom().getY() != e.getTo().getY())) {
    ...
    private void naodroparkits(final PlayerDropItemEvent e) {
        if (e.getItemDrop().getItemStack().getType() == Material.FIREWORK | e.getItemDrop().getItemStack().getType() == Material.IRON_FENCE | e.getItemDrop().getItemStack().getType() == Material.SNOW_BALL | e.getItemDrop().getItemStack().getType() == Material.STONE_AXE | e.getItemDrop().getItemStack().getType() == Material.FEATHER | e.getItemDrop().getItemStack().getType() == Material.FISHING_ROD | e.getItemDrop().getItemStack().getType() == Material.LEASH | e.getItemDrop().getItemStack().getType() == Material.IRON_FENCE | e.getItemDrop().getItemStack().getType() == Material.BOW | e.getItemDrop().getItemStack().getType() == Material.ARROW | e.getItemDrop().getItemStack().getType() == Material.REDSTONE_BLOCK | e.getItemDrop().getItemStack().getType() == Material.LAPIS_BLOCK | e.getItemDrop().getItemStack().getType() == Material.BOOK) {
            e.setCancelled(true);
            e.getPlayer().updateInventory();
        }
    ...
    private void bussola(final PlayerInteractEvent e) {
        ...
        if (jogador.getItemInHand().getType() == Material.COMPASS) {
            for (int i = 0; i < 1000; ++i) {
                final List<?> pertos = (List<?>)jogador.getNearbyEntities((double)i, 125.0, (double)i);
                for (final Object jogadores : pertos) {
                    if (jogadores instanceof Player) {
                        final Player jogadorencontrado = (Player)jogadores;
                        if (jogador.getLocation().distance(jogadorencontrado.getLocation()) <= 10.0 || Manager.Admin.contains(jogadorencontrado)) {
                            continue;
                        }
                        achou = true;
                        jogador.sendMessage(String.valueOf(Manager.prefix) + " §aBussola apontando para §f" + jogadorencontrado.getName() + "§a.");
                    }
                }
                if (achou) {
                    break;
    ...
    private void combatlog(final EntityDamageByEntityEvent e) {
        if (e.getDamager() instanceof Player && e.getEntity() instanceof Player) {
            ...
            if (!Manager.pegarCombat(hitter) && !Manager.pegarCombat(p) && !Manager.pegarKit(p).equalsIgnoreCase("none") && !Manager.pegarKit(hitter).equalsIgnoreCase("none")) {
                ...
                p.sendMessage(String.valueOf(Manager.prefix) + " §7Voc\u00ea §aentrou §7de combate com §f" + hitter.getName() + "§7.");
                hitter.sendMessage(String.valueOf(Manager.prefix) + " §7Voc\u00ea §aentrou §7de combate com §f" + p.getName() + "§7.");
                Bukkit.getScheduler().scheduleSyncDelayedTask(FantasyKits.getPlugin(), (Runnable)new Runnable() {
                    @Override
                    public void run() {
                        Manager.Combate.remove(p);
                        Manager.Combate.remove(hitter);
                        p.sendMessage(String.valueOf(Manager.prefix) + " §7Voc\u00ea §csaiu §7de combate com §f" + hitter.getName() + "§7.");
                        hitter.sendMessage(String.valueOf(Manager.prefix) + " §7Voc\u00ea §csaiu §7de combate com §f" + p.getName() + "§7.");
                    }
                }, 800L);
            }
        }
    ...
    private void bloquear(final PlayerCommandPreprocessEvent event) {
        ...
        if (Manager.pegarCombat(p) && (event.getMessage().toLowerCase().startsWith("/1v1") || event.getMessage().toLowerCase().startsWith("/spawn") || event.getMessage().toLowerCase().startsWith("/kit") || event.getMessage().toLowerCase().startsWith("/warp"))) {
            event.setCancelled(true);
            p.sendMessage(String.valueOf(Manager.prefix) + " §cDesculpe, Mas E Este Comando Esta Bloqueado Em Combate.");
        }
    }
    ...
    private void inv(final PlayerInteractEvent e) {
        final Player p = e.getPlayer();
        if (e.getAction() == Action.RIGHT_CLICK_BLOCK && e.getAction() == Action.RIGHT_CLICK_BLOCK && e.getClickedBlock() != null && (e.getClickedBlock().getType() == Material.WALL_SIGN || e.getClickedBlock().getType() == Material.SIGN_POST)) {
            final Sign s = (Sign)e.getClickedBlock().getState();
            final String[] lines = s.getLines();
            if (lines.length > 0 && lines[0].equals("§5Fantasy§eKits") && lines.length > 1 && lines[1].equals("§a\u25ba Sopas")) {
                final Inventory inve = Bukkit.getServer().createInventory((InventoryHolder)p, 54, "§a\u25ba Sopas");
                final ItemStack primary = Manager.criarItem2(Material.MUSHROOM_SOUP, "§a\u25ba Sopa", (short)0, 1, new String[] { "§7Tome Para Regenerar Sua Vida." });
            ...
            if (lines.length > 0 && lines[0].equals("§5Fantasy§eKits") && lines.length > 1 && lines[1].equals("§c\u25ba Recraft")) {
                p.getInventory().addItem(new ItemStack[] { Manager.criarItem2(Material.BOWL, "§b\u25ba Tigela", (short)0, 64, new String[0]) });
                p.getInventory().addItem(new ItemStack[] { Manager.criarItem2(Material.RED_MUSHROOM, "§c\u25ba Cogumelo", (short)0, 64, new String[0]) });
                p.getInventory().addItem(new ItemStack[] { Manager.criarItem2(Material.BROWN_MUSHROOM, "§6\u25ba Cogumelo", (short)0, 64, new String[0]) });
                p.updateInventory();
            }
        }
    }
    ...
    private void SemDano2(final EntityDamageEvent event) {
        if (event.getEntity() instanceof Player) {
            ...
            if (this.nofalldamagec.contains(player.getName()) && event.getCause().equals((Object)EntityDamageEvent.DamageCause.FALL)) {
                event.setCancelled(true);
    ...
    private void clicarinventariokits(final InventoryClickEvent e) {
        ...
        if (e.getCurrentItem() != null && e.getCurrentItem().getItemMeta() != null && e.getCurrentItem().getItemMeta().getDisplayName() != null) {
            ...
            if (e.getInventory().getTitle().equalsIgnoreCase("§7Op\u00e7\u00f5es \u25ba ")) {
                ...
                if (e.getCurrentItem().getItemMeta().getDisplayName().equalsIgnoreCase("§c\u25ba Voce N\u00e3o Tem Esta Op\u00e7\u00e3o")) {
                    e.setCancelled(true);
                    jogador.updateInventory();
                ...
                else if (e.getCurrentItem().getItemMeta().getDisplayName().equalsIgnoreCase("§a\u25ba Receber Report - Ativado")) {
                    e.setCancelled(true);
                    jogador.updateInventory();
                    jogador.playSound(jogador.getLocation(), Sound.CLICK, 2.0f, 2.0f);
                    e.setCurrentItem(Manager.criarItem(Material.INK_SACK, "§c\u25ba Receber Report - Desativado", (short)8, new String[] { "", "§7Clique Para Alterar." }));
                    Manager.Report.put(jogador.getName(), false);
                }
                else if (e.getCurrentItem().getItemMeta().getDisplayName().equalsIgnoreCase("§c\u25ba Receber Report - Desativado")) {
                    e.setCancelled(true);
                    jogador.updateInventory();
                    jogador.playSound(jogador.getLocation(), Sound.CLICK, 2.0f, 2.0f);
                    e.setCurrentItem(Manager.criarItem(Material.INK_SACK, "§a\u25ba Receber Report - Ativado", (short)10, new String[] { "", "§7Clique Para Alterar." }));
                    Manager.Report.put(jogador.getName(), true);
                }
                else if (e.getCurrentItem().getItemMeta().getDisplayName().equalsIgnoreCase("§a\u25ba Receber Tell - Ativado")) {
                    e.setCancelled(true);
                    jogador.updateInventory();
                    jogador.playSound(jogador.getLocation(), Sound.CLICK, 2.0f, 2.0f);
                    e.setCurrentItem(Manager.criarItem(Material.INK_SACK, "§c\u25ba Receber Tell - Desativado", (short)8, new String[] { "", "§7Clique Para Alterar." }));
                    Manager.Tell.put(jogador.getName(), false);
                }
                else if (e.getCurrentItem().getItemMeta().getDisplayName().equalsIgnoreCase("§c\u25ba Receber Tell - Desativado")) {
                    e.setCancelled(true);
                    jogador.updateInventory();
                    jogador.playSound(jogador.getLocation(), Sound.CLICK, 2.0f, 2.0f);
                    e.setCurrentItem(Manager.criarItem(Material.INK_SACK, "§a\u25ba Receber Tell - Ativado", (short)10, new String[] { "", "§7Clique Para Alterar." }));
    ...
    public void Damage(final EntityDamageByEntityEvent e) {
        if (e.getEntity() instanceof Player && e.getDamager() instanceof Player && Manager.pegarKit((Player)e.getEntity()).equalsIgnoreCase("Lava")) {
            final Player p = (Player)e.getDamager();
            if (Manager.pegarKit(p).equalsIgnoreCase("Lava") && Manager.pegarKit((Player)e.getEntity()).equalsIgnoreCase("Lava")) {
                e.setCancelled(true);
            }
        }
    }
    ...
    private void semcomandos(final PlayerCommandPreprocessEvent e) {
        if ((Manager.pegarKit(e.getPlayer()).equalsIgnoreCase("Fps") || Manager.pegarKit(e.getPlayer()).equalsIgnoreCase("Lava") || Manager.pegarKit(e.getPlayer()).equalsIgnoreCase("Potion") || Manager.pegarKit(e.getPlayer()).equalsIgnoreCase("Main")) && !e.getMessage().startsWith("/spawn")) {
            e.getPlayer().sendMessage(String.valueOf(Manager.prefix) + " §cDesculpe,mas voc\u00ea n\u00e3o pode usar Comandos em warps.");
            e.setCancelled(true);
        }
    }
}
